...
def processArm(event):
      global command, lightc, shoulder, base, elbow, wristup, wristdown, grip_open, grip_close, grip_command, wrist_command, shoulder_command, base_command, elbow_command
	...
	#print "event.value = " + str(event.value)
        ...
        newcommand = buildcommand(shoulder_command,base_command, 
                                  elbow_command, wrist_command, grip_command,lightc)
